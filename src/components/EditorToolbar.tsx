...
interface EditorToolbarProps {
  ...
  hasProcessedVersion: boolean // 新增：是否有已处理版本
  isViewingProcessed: boolean // 新增：是否正在查看处理结果
  ...
  onLoadProcessed: () => void // 新增：加载已处理版本
...
const EditorToolbar: React.FC<EditorToolbarProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* View Processed Button - 有已处理版本且当前未显示时显示 */}
      {hasProcessedVersion && !isViewingProcessed && (
        <Button
          primary
          onClick={onLoadProcessed}
